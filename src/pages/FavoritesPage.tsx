...
import { IconStarFilled, IconShare, IconCheck } from '../components/icons/Icons'
              ...
              >
                ...
                <div className="flex gap-2 mt-3">
                  ...
                  <button
                    ...
                    className="px-4 py-3 bg-surface-2 text-text-muted text-xs font-heading font-bold tracking-wider border border-surface-3 uppercase flex items-center gap-1.5"
                  >
