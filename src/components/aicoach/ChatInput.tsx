...
export default function ChatInput({ onSend, disabled, placeholder }: ChatInputProps) {
  ...
  return (
    <div className="border-t border-surface-3 bg-surface-0 p-3 shrink-0">
      <div className="flex gap-2 items-end">
        <textarea
          ...
          rows={1}
          className={cn(
            'flex-1 min-w-0 bg-surface-1 border-2 border-surface-3 px-3 py-2',
            'text-xs font-mono text-text-primary placeholder-text-ghost',
            'focus:border-primary-500 focus:outline-none',
            'resize-none transition-colors break-words',
